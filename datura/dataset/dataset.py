...
class SyntheticTwitterQuestionsDataset:
    ...
    async def generate_question(self):
        ...
        system_message = f"""You are an expert technology analyst generating realistic Twitter search queries about {topic}.
...
- Include context that makes the query valuable for industry insights
- Avoid hypothetical or overly broad queries
- Focus on practical, real-world implications
- Do not include any hashtags unless they are commonly used for {topic}
- Do not generate long queries that include more than 8 words. Please generate short and clear queries like real ones from humans
- Do not generate multiple queries at a time. You need to make one query at a time
